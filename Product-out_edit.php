            ...
            <div class="row">
              <div class="col-md-12">
                    ...
                    <form action="update-Product-out.php" method="POST">
                        ...
                        <p>Date : <input name="date" type="date" value="<?php echo $data['date'] ; ?>" class="form-control" placeholder="select Date "></p>
                        ...
                        <p>Type : <input name="type" type="text" value="<?php echo $data['type'] ; ?>" class="form-control" placeholder="Enter User type "></p>
